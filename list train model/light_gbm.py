...
# Skrip standar untuk melatih model LightGBM Regressor
...
def build_and_train(
    ...
    """
    Build and train a LightGBM Regressor model, then evaluate using MAPE.
    ...
    Returns:
        model: Trained LGBMRegressor instance.
